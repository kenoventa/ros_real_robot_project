...
"""autogenerated by genpy from turtlebot3_move/OdomRecordActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class OdomRecordActionFeedback(genpy.Message):
  ...
  _type = "turtlebot3_move/OdomRecordActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtlebot3_move/OdomRecordFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = turtlebot3_move.msg.OdomRecordFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = turtlebot3_move.msg.OdomRecordFeedback()
